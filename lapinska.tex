...
Empirical studies confirm that the degree of trade imbalance exerts a~negative impact on the intensity of intra-industry trade (see, for instance, Lee and Sohn, 2004; Thorpe and Zhang, 2005; Leit\~ao, 2011). If trade between two countries is not balanced, then the intensity of the intra-industry trade index cannot reach its maximum value. The degree of trade imbalance is determined mostly by means of the following formula (Lee, Lee, 1993):
\begin{eqnarray}
...
There are many methods for measuring intra-industry trade. An overview is presented by such authors as, for instance, Vona (1991), or £apiñska (2003). However, most empirical studies measuring the intensity of intra-industry trade employ the Grubel-Lloyd index, calculated according to the following formula (Grubel and Lloyd, 1975):
     \begin{eqnarray}
...
The study included 26 of Poland's trade partners that were members of the European Union in 2011. The following were taken as potential explanatory variables: GDP, GDP \fntit{per capita}, the index of the relative difference in trading partners' GDP, and the index of the relative difference in trading partners' GDP \fntit{per capita}. Also, the impact of geographical distance between countries was taken into account and was expressed in the number of kilometres between their capitals. In addition, the impact of European Union membership on the increase in the intensity of intra-industry trade was examined. For this purpose, an additional dummy variable for EU was introduced. The model also takes into account use by Poland's trade partners of a~similar language, i.e., one belonging to the group of Slavic languages. Therefore, yet another dummy variable ($LANG$), was added to the model.

Due to the fact that the dependent variable $GL_{kt}$ is an index taking on values from the interval [0;1], a~logit transformation of the dependent variable was performed. In this manner, we obtained a~dependent variable in the form of the logit $\ln(GL_{kt}/1-GL_{kt}$) and this dependent variable's values are contained in the interval ($-\infty$;$\infty$). This eliminated the possibility of obtaining theoretical values of the Grubel-Lloyd index beyond the acceptable interval [0;1].\pozn{In cases where the index of intra-industry trade ($GL_{kt}$) took the value of 0, a~procedure proposed by Lee and
 Lee (1993) was applied. It assumes that the dependent variable ($GL_{kt}$) takes on a~very small value equal to 
...
\item[H3:] There is a~positive relationship between the level of economic development of European Union member states, as measured by the size of their GDP \fntit{per capita}, and the intensity of intra-industry trade between these countries.
\item[H4:] There is a~negative correlation between relative differences in income \fntit{per capita} of trading partners and the intensity of intra-industry trade.  
...
\tabcolsep 4pt\small\zacltab{|c|p{107mm}|}\hline
\bf Variables 		& \bf Variables description\\\hline
\endhead
\hline\mc{2}{r}{\fntit{Continued on next page}}\endfoot
\endlastfoot
...
$PCI_{kt}$		&	Gross Domestic Product \fntit{per capita} of the partner country $k$, in the time period $t$.\\
				&	Data source: The World Bank (2014).  \fntit{World Development Indicators}.\\
$DGDP_{kt}$		&	The index of the relative difference in the size of Poland's GDP and GDP of the partner country $k$, in the time period $t$. The index values are measured by means of the following formula:\\
	...
	&	The above index takes on values from the interval [0;1]. If the differences in GDP between countries are large, then the index approaches the value of 1. When GDP is identical for both countries, then it equalizes 0. \\
$DPCI_{kt}$,	&	The index of the relative difference in Poland's GDP income \fntit{per capita} and in GDP of its partner country $k$, in the time period $t$. The index values are calculated with the use of the formula constructed as in the case of DGDPkt.\\
...
Heteroscedasticity affects inappropriate estimations of standard errors for individual \mbox{parameters} and the revaluation of the determination coefficient, which may distort the conclusions regarding the significance of variables. Therefore, to ultimately estimate the parameters, the weighted least-squares method was applied ($WLS$).\\
...
Independent 	&	Coefficient	&	Standard 	&\fntit{t-statistics} 	&\fntit{p-value} 		&	Significance\raisebox{1.1ex}{\scriptsize{a)}}\\
...
\mc{2}{|c}{$\mathrm{F} (7, 252) = 71,32568$}		&	\mc{4}{c|}{\fntit{p-value} for test $\mathrm{F} <0,00001$}\\\hline
\kontab
...
The research conducted shows that the development of this type of trade exchange in Poland is positively influenced by the intensity of trade with European Union countries and by the level of economic development of the member states (as measured by the size of their GDP \fntit{per capita}). The development of intra-trade turnover is also encouraged by such factors as EU membership and the fact that Poland's trade partners use similar Slavic languages. The relative differences in the size of the economies and the relative differences in Poland's and its trading partners' levels of economic development have a~negative impact. The degree of the trade imbalance between trading partners also negatively influences the intensity of mutual intra-trade exchange. The study confirmed that the impact of all of the identified determinants of intra-industry trade is consistent with the predictions of the theory.\\[6mm]
     

\cast{References}
Balassa, B., Bauwens, L. (1987). Intra-Industry Specialisation in a~Multi-Country and Multi-Industry Framework. \fntit{The Economic Journal}, 97, 923--939. 

Baltagi, B.\;H. (2001). \fntit{Econometric Analysis of Panel Data}, (2\numend{nd} ed.). Chichester: John Wiley \&\,Sons. 

Van Bergeijk P.\;A.\;G., Brakman S. (2010). \fntit{The Gravity Model in International Trade: Advances and Applications}. Cambridge: Cambridge University Press.

\clearpage\newpage

Bergstrand, J.\;H. (1990). The Heckscher-Ohlin-Samuelson Model, the Linder hypothe\-sis and the determinants of bilateral intra-industry trade. \fntit{The Economic Journal}, 100, \mbox{1216--1229}.

Botriæ, V. (2013). Determinants of Intra-industry Trade between Western Balkans and EU-15: Evidence from Bilateral Data. \fntit{International Journal of Economic Sciences and Applied Research}, 6(2), 7--23. 

Byun, J.\;J., Lee, S.-H. (2005). Horizontal and Vertical Intra-Industry Trade: New Evidence from Korea, 1991--1999. \fntit{Global Economy Journal}, 5(1), 1--29. 

Centre D'Etudes Prospectives et D'Informations Internationales. (2014). \fntit{GeoDist}. Retrieved on April 25, 2014, from http://www.cepii.fr/anglaisgraph/bdd/distances.htm.

Cie¶lik, A. (2000). \fntit{Nowa teoria handlu zagranicznego w ¶wietle badañ empirycznych}. Warszawa: Wydawnictwo Naukowe PWN.

Clark, D.\;P., Stanley, D.\;L. (1999). Determinants of Intra-Industry Trade Between Develop\-ing Countries and the United States. \fntit{Journal of Economic Development}, 24(2), 79--95. 

Crespo, N., Fontoura, M.\;P. (2004). Intra-Industry Trade by Types: What Can We Learn from Portuguese Data? \fntit{Review of World Economics}, 140(1), 52--79.

Czarny, E., ¦ledziewska, K. (2009). \fntit{Polska w handlu ¶wiatowym}. Warszawa: Polskie Wydawnictwo Ekonomiczne. 

Czarny, E. (2002). \fntit{Teoria i~praktyka handlu wewn±trzga³êziowego}. Warszawa: Oficyna Wydawnicza Szko³y G³ównej Handlowej.

Ekanayake, E.\;M. (2001). Determinants of Intra-Industry Trade: The Case of Mexico. \fntit{The International Trade Journal}, 15(1), 89--112. 

Globerman, S., Dean, J.\;W. (1990). Recent Trends in Intra-Industry Trade and Their Implications for Future Trade Liberalization. \fntit{Weltwirtschaftliches Archiv}, 126(1), 25--49.

Grubel, H.\;G., Lloyd, P.\;J. (1975). \fntit{Intra-Industry Trade: The Theory and Measurement of International Trade in Differentiated Products}. London: Macmillan.

Helpman, E. (1987). Imperfect Competition and International Trade: Evidence from Fourteen Industrial Countries. \fntit{Journal of the Japanese and International Economies}, 1, 62--81. 

Helpman, E., Krugman, P.\;R. (1985). \fntit{Market Structure and Foreign Trade: Increasing Returns, Imperfect Competition, and the International Economy}. Cambridge Massachusetts: MIT Press.

£apiñska, J. (2003). Metodologia pomiaru strumieni handlu wewn±trzga³êziowego. \fntit{Acta Universitatis Nicolai Copernici} Ekonomia XXXIII, 367, 113--127.

Lee, H.-H., Lee, Y.-Y. (1993). Intra-Industry Trade in Manufactures: The Case of Korea. \fntit{Weltwirtschaftliches Archiv}, 129(1), 159--171. 

Lee, H.-H., Sohn, Ch.-H. (2004). South Korea's Marginal Intra-Industry Trade and Choice of Preferential Partners. \fntit{Asian Economic Papers}, 3(3), 94--116.

Leit\~ao, N.\;C. (2011). Intra-industry trade in the agriculture sector: The experience of United States. \fntit{African Journal of Agricultural Research}, 6(1), 186--190.

Linder, S.\;B. (1961). \fntit{An Essay on Trade and Transformation}. Stockholm: John Wiley \&~Sons; Almqvist \& Wiksell. 

Loertscher, R., Wolter, F. (1980). Determinants of Intra-Industry Trade: Among Countries and Across Industries. \fntit{Weltwirtschaftliches Archiv}, 116(2), 280--293. 

Markusen, J.\;R., Venables, A.\;J. (1996). \fntit{The Theory of Endowment, Intra-Industry and Multinational Trade}, NBER Working Paper No 5529. Retrieved on April 17, 2014, from http://www.nber.org/pa\-pers/w5529.pdf?new\_window=1.

Mulenga, M.\;C. (2012). \fntit{An Investigation of the Determinants of Intra-Industry Trade Between Zambia and its Trading Partners in the Southern African Development Community (SADC)}. TIPS Working Paper Series. Retrieved on April 17, 2014, from http://www.tips.\\org.za.

Muszyñska, J. (2006). Modelowanie danych panelowych. \fntit{Zeszyty Naukowe Pañstwowej Wy¿szej Szko³y Zawodowej we W³oc³awku}, 1, 213--236. 

Niem, L.\;D., Kim, T. (2010). Technology, Preference for Quality, and Vertical Intra-Industry Trade. \fntit{Modern Economy}, 1, 129--133. 

Okubo, T. (2007). Intra-Industry Trade, Reconsidered: The Role of Technology Transfer and Foreign Direct Investment. \fntit{The World Economy}, 30(12), 1855--1876. 

Onogwu, G.\;O. (2013). Regional Characteristics Effects on Intra-Industry Trade in Residues and Wastes from Food Mill Industry. \fntit{Journal of Agriculture and Sustainability}, 3(1), 108--121. 

Pietrzak, M.\;B., £apiñska, J. (2014). Zastosowanie modelu grawitacji do identyfikacji czynników determinuj±cych przep³ywy handlowe w Unii Europejskiej. \fntit{Przegl±d Statystyczny}, 61(4), 65--77.

Ramakrishnan, A., Varma, P. (2014). Do free trade agreements promote intra-industry trade? The case of India and its FTAs. \fntit{International Journal of Trade and Global Markets}, 7(2), 129--144.

Sotomayor, M. (2012). Patterns and Determinants of Intra-Industry Trade for the Mexican Non-Maquiladora Manufacturing Industry. \fntit{The Journal of Business Inquiry}, 11(1), 33--57.

Sudsawasd, S. (2012). Trade Integration in East Asia: An Empirical Assessment. \fntit{Modern Economy}, 3, 319--329.

%\clearpage\newpage

The World Bank. (2014). \fntit{World Development Indicators}. Retrieved on April 25, 2014, from http://da\-ta.worldbank.org/data-catalog/world-development-indicators.

Thorpe, M., Zhang, Z. (2005). Study of the Measurement and Determinants of Intra-Industry Trade in East Asia. \fntit{Asian Economic Journal}, 19(2), 231--247.

Turmo, J., Hervitz, H.\;M., Moslares, C. (2005). An Analysis of the Determinants of Intra-Industry Trade: The Case of Spanish Foreign Trade. \fntit{International Business \& Economic Research Journal}, 4(3), 53--62.

United Nations. (2014). \fntit{UN Comtrade Database}. Retrieved on April 17, 2014, from http://comtra\-de.un.org/data/. 

Vona, S. (1991). On the Measurement of Intra-Industry Trade: Some Further Thoughts. \fntit{Weltwirtschaftliches Archiv}, 127(4), 678--700. 

Wakasugi, R. (2007). Vertical Intra-Industry Trade and Economic Integration in East Asia. \fntit{Asian Economic Papers}, 6(1), 26--39.

Zhang, Y., Clark, D.\;P. (2009). Pattern and Determinants of United States' Intra-Industry Trade. \fntit{The International Trade Journal}, 23(3), 325--356. 

Zhang, Z., Li, C. (2006). Country-Specific Factors and the Pattern of Intra-Industry Trade in China's Manufacturing. \fntit{Journal of International Development}, 18, 1137--1149.
