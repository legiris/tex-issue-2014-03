...
Baur, S. (2009). Sprachenlernen und Kompetenzen in einem mehrsprachigen europäischen Gebiet. In Autonome Provinz Bozen-Südtirol (Eds.), \fntit{Sprachkompetenzen am Südtiroler Arbeitsmarkt} (pp. 59--68), Bozen.
...
Gudauner, K. (2009). Rahmenbedingungen für den Sprachenerwerb in der Produktionswelt. In Autonome Provinz Bozen-Südtirol (Eds.), \fntit{Sprachkompetenzen am Südtiroler Arbeitsmarkt} (pp. 9--13), Bozen.

\clearpage\newpage

Höffe, O. (1999). Ein Gesellschaftsvertrag für Europa? Ein Versuch in dreizehn Thesen. In Anselm, E./Freytag, A./Marschitz, W./Marte, B. (Eds.), \fntit{Die neue Ordnung des Politischen. Die Herausforderungen der Demokratie am Beginn des 21. Jahrhunderts} (pp. 267--278), Frankfurt/ M./New York: Campus.
...
Loi, M. (2009). Sprachkompetenzen in Südtirol: Deutung der Ergebnisse unter dem Blick\-winkel der Humankapitaltheorie. In Autonome Provinz Bozen-Südtirol (Eds.), \fntit{Sprachkompetenzen am Südtiroler Arbeitsmarkt} (pp. 49--57), Bozen.
...
Pörnbacher, K. (2009). Sprachenlernen am Arbeitsplatz: Zwang, Chance oder Recht? In Autonome Provinz Bozen-Südtirol (Eds.), \fntit{Sprachkompetenzen am Südtiroler Arbeitsmarkt} (pp. 23--33), Bozen.

Pörnbacher, K. (2009). Sprachkompetenzen als Wettbewerbsfaktor für Südtirols Betriebe. In Autonome Provinz Bozen-Südtirol (Eds.), \fntit{Sprachkompetenzen am Südtiroler Arbeitsmarkt} (pp. 35--42), Bozen.

Riemeck, R. (1997). \fntit{Mitteleuropa: Bilanz eines Jahrhunderts}. Stuttgart: Verlag Engel \&~Co.

Ritzer, G. (2011). Die McDonaldisierung von Gesellschaft und Kultur. In Stephan Moebius \& Dirk Quadflieg (Eds.), \fntit{Kultur. Theorien der Gegenwart} (pp. 371--378). Wiesbaden: VS Verlag für Sozialwissenschaften.
